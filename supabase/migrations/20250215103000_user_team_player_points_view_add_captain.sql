-- Add is_captain to user_team_player_points_view (drop+create to avoid column rename issues)

drop view if exists public.user_team_player_points_view;

create view public.user_team_player_points_view as
with roster as (
  select fantasy_team_id, player_id, joined_at, left_at, is_captain
