...
| 004 | 2025-10-26 | Roster Rules | Changed roster size to 8; ensure validation, counters, and budget bar reflect new rules | Medium | Open | Cursor | Cursor | 1. Update docs/constants<br>2. Run roster validation in app | Validation matches 8-player rules | Counters still assume 10-player roster | Dev |
